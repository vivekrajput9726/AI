...
from app.routes import auth, users, doctors, appointments, ai_routes, admin, video, chat, health_records, prescription_ai, meetings, whatsapp, emergency, family, wellness, extras, medicines, goals, insurance, payments, doctor_ai, notifications
...
app.include_router(goals.router,      prefix="/api/goals",      tags=["Health Goals"])
app.include_router(insurance.router,  prefix="/api/insurance",  tags=["Insurance"])
app.include_router(payments.router,   prefix="/api/payments",   tags=["Payments"])
app.include_router(doctor_ai.router,    prefix="/api/doctor-ai",    tags=["Doctor AI Assistant"])
