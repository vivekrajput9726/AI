...
async def get_health_tips(current_user: dict = Depends(get_current_user)):
    ...
    tips = [
        ...
        {"tip": "Walk for at least 30 minutes every day to improve heart health.", "category": "Fitness"},
        {"tip": "Eat 5 portions of fruits and vegetables every day for essential vitamins.", "category": "Nutrition"},
        {"tip": "Sleep 7-9 hours per night. Quality sleep repairs your body and mind.", "category": "Sleep"},
        {"tip": "Practice 5 minutes of deep breathing to reduce stress and anxiety.", "category": "Mental Health"},
        {"tip": "Wash hands frequently - it prevents 80% of common infections.", "category": "Hygiene"},
        {"tip": "Limit screen time before bed. Blue light disrupts melatonin production.", "category": "Sleep"},
        {"tip": "Eat breakfast every day. It boosts metabolism and improves concentration.", "category": "Nutrition"},
        {"tip": "Take a 5-minute break every hour if you sit at a desk.", "category": "Fitness"},
        {"tip": "Include protein in every meal - eggs, dal, paneer, or nuts.", "category": "Nutrition"},
        {"tip": "Regular health check-ups can detect problems before they become serious.", "category": "Prevention"},
        {"tip": "Avoid smoking. It's the leading cause of preventable death worldwide.", "category": "Prevention"},
        {"tip": "Laughing reduces stress hormones and boosts your immune system.", "category": "Mental Health"},
        {"tip": "Sunlight in the morning helps regulate your body clock and mood.", "category": "Wellness"},
        {"tip": "Maintain a healthy weight - even a 5% reduction improves many conditions.", "category": "Fitness"},
    ]
